# In-depth Financial and Regional Performance Analysis of Agrani Bank Plc (2019-2023)

## Project Overview
This project involves a comprehensive process of data aggregation, cleaning, analysis, and visualization of Agrani Bank Plc's branch performance across Bangladesh from 2019 to 2023. The dataset includes detailed information about branches, operational Thanas, divisions, addresses, and the bank's financial performance in terms of profit, revenue, and expenses. The main objective is to provide insights into Agrani Bank's financial performance across these years, using visualizations to depict trends, patterns, and comparisons across branches, districts, divisions, and Thanas.

## Objective
The key objectives of the project are:
- **Revenue, Expense, and Profit (2019-2023):** Collection of total revenue, expense, and profit for five years and distribution by the percentage of branches within each division.
- **Thana Population Data:** Manually collecting population data for 434 Thanas, and randomly distributing the population data to allocate financial figures (profit, revenue, expense) to 941 branches.
- **Geospatial Mapping:** Adding branch addresses and corresponding map coordinates.
- **Performance Analysis:** Visualizing various financial and operational KPIs such as profit margin, expense ratio, and cost efficiency, analyzing their evolution across years, divisions, districts, and branches.
- **Comparison by Region:** Identifying regional trends in revenue, expense, and profit, with comparisons between high-performing and low-performing regions like Dhaka, Chattogram, Khulna (highest performing) and Rangpur, Sylhet, Barishal (lowest performing).

## Data Sources
- **Agrani Bank Data:** Collected from the Bangladesh Bank branch list PDF. Data was filtered, copied, and connected to Google Sheets, then exported to Excel for analysis.
- **Annual Report:** Financial data (revenue, expense, and profit) from 2019-2023, obtained from Agrani Bank’s 2023 Annual Report, specifically from page 174. [Agrani Bank Annual Report 2023](https://www.agrani.com.bd/annual-reports)
- **Thana Population Data:** Manually sourced for 434 Thanas from:
   - Wikipedia
   - Banglapedia
   - CityPopulation
   - The Bangladesh Network (thebangladeshnetwork.com)
   - Portal.govt.bd
- **Branch Address and Map Coordinates:** Obtained from BanksBD Agrani Bank Branch List.

## Tools Used
- **Google Sheets:** Used to convert data from PDF to Sheets for easy manipulation and analysis.
- **Excel:** Linked with Agrani Bank's data from Google Sheets for further processing.
- **Google Search:** Assisted in gathering Thana population and branch address data.
- **Google Maps:** Used to retrieve map coordinates of the branches.
- **Power BI:** Employed for data visualization and generating insightful charts and graphs to present findings.
